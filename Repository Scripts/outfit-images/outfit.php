...
function cacheExists($outfit_id, $addons, $head, $body, $legs, $feet)
{
	return file_exists('cache/' . $outfit_id . '_' . $addons . '_' . $head . '_' . $body . '_' . $legs . '_' . $feet . '.png');
}

function cachePath($outfit_id, $addons, $head, $body, $legs, $feet, $generateDirs)
{
	if($generateDirs)
	{
		mkdir('cache/' . $outfit_id . '/' . $addons . '/' . $head . '/' . $body . '/' . $legs, 0705, true);
	}
	return 'cache/' . $outfit_id . '/' . $addons . '/' . $head . '/' . $body . '/' . $legs . '/' . $feet . '.png';
}
